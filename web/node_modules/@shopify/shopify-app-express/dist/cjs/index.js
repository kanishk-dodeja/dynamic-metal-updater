...
var index$1 = require('./auth/index.js');
var index = require('./webhooks/index.js');
...
function shopifyApp(config) {
    ...
    return {
        ...
        api: api,
        auth: index$1.auth({ api, config: validatedConfig }),
        processWebhooks: index.processWebhooks({ api, config: validatedConfig }),
...
function deprecated(warningFunction) {
    return function (version$1, message) {
        if (compareVersions.compare(version.SHOPIFY_EXPRESS_LIBRARY_VERSION, version$1, '>=')) {
